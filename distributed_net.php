...
<head>
    ...
    <title>Distribution Network | Adister</title>
...
<body>
 ...
 <?php include './header.php'; ?>
        ...
        <div class="row">
             <div class="col-md-12">
                 <div class="center gap">
                        <h2>We Distribute in Major Cities</h2>
                    </div>                
                </div>
            <div class="col-sm-6">
                <div class="gap"></div>
                <blockquote>
                <h4> Started from dorms of IIT Roorkee, we are now operational across Delhi and Mumbai and are selling 1 lac+ notebooks a month</h4>   
                </blockquote>
                <blockquote>
                <h4>These notebooks are sold via over 200+ retail outlets at low  cost ensuring it  swiftly  reaches  to the  right target group.</h4>
                </blockquote>
                <div class="gap"></div>
            </div><!--/.col-sm-6-->
            <div class="col-md-6" id="mapp">
                <center><img id="map" src="adi_img/map_india.png" class="img-responsive "></center>
            </div>
        </div><!--/.row-->
         <hr>
        </div>
    ...
    <div class="container">
        <center><h4>If you cannot find adister at a specific area/store and you want them to please let us know @ 022-400 50 165 or write to us at hello@adister.in​</h4></center>
    </div>
